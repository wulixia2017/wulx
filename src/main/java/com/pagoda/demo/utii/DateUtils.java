...
public class DateUtils {
     ...
     * 拼团自提日期
     */
    public final static String DATE_PATTERN_GROUP_DELIVERY = "MM月dd日";
    /**
     ...
     * 配送时间格式
     */
    public final static String DATETIME_DELIVERY_PATTERN = "MM-dd HH:mm";
    ...
    public static String getTodayStr() {
        ...
        Integer num12 = 12;
        Integer num13 = 13;
        nowString = nowString + now.get(num1) + "-";
        Integer month = now.get(num2) + 1;
        if (month < num10) {
            monthString = "0" + month;
        } else {
    ...
    public static Date parse(String strDate) throws ParseException {
        return StringUtils.isEmpty(strDate) ? null : parse(strDate, DATETIME_PATTERN_CREAT_ORDER);
    }
    ...
    public static Date stringToDate(String time) {
        ...
        try {
            ...
            throw new BusinessException(ErrorCode.ERROR_CONVERT_DATE,e);
        }
        return date;
    }
    ...
    public static String getDateDesc(Date date) {
        ...
        Date dayAfterTomorrow = addDay(tomorrow, 1);
